...
/***/ "./node_modules/engine.io-client/node_modules/base64-arraybuffer/dist/base64-arraybuffer.es5.js":
/*!******************************************************************************************************!*\
  !*** ./node_modules/engine.io-client/node_modules/base64-arraybuffer/dist/base64-arraybuffer.es5.js ***!
  \******************************************************************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var utils_1 = __importStar(__webpack_require__(/*! ../utils/utils */ "./src/utils/utils.ts"));
var Map = (function () {
    function Map(scene) {
        this.chekpoints = [];
        this._scene = scene;
    ...
    Map.prototype.createCollisions = function () {
        var _this = this;
        this.tilemap.findObject("collisions", function (collisionObject) {
            var castedObject = collisionObject;
            var sprite = _this._scene.matter.add.sprite(castedObject.x + castedObject.width / 2, castedObject.y - castedObject.height / 2, "objects", collisionObject.name);
            sprite.setStatic(true);
        });
    };
    Map.prototype.createChekpoints = function () {
        var _this = this;
        var array = this.tilemap.filterObjects("checkpoints", function (checkpoint) { return checkpoint.name === "checkpoint"; });
        array.forEach(function (item) {
            var rectangle = new utils_1.default(item.x, item.y, item.width, item.height);
            rectangle.index = item.properties.find(function (prop) { return prop.name === "value"; }).value;
            _this.chekpoints.push(rectangle);
        });
    };
    Map.prototype.createArrows = function () {
    };
    Map.prototype.createOils = function () {
        var _this = this;
        this.tilemap.findObject("oils", function (oilObject) {
            var castedObject = oilObject;
            var sprite = _this._scene.matter.add.sprite(castedObject.x + castedObject.width / 2, castedObject.y - castedObject.height / 2, "objects", oilObject.name);
            sprite.setStatic(true);
    ...
    Map.prototype.getTileFriction = function (car) {
        for (var roadType in utils_1.ROADS_FRICTION) {
            var tile = this.tilemap.getTileAtWorldXY(car.x, car.y, false, this._scene.cameras.main, roadType);
            if (tile)
                return utils_1.ROADS_FRICTION[roadType];
        }
        return utils_1.GRASS_FRICTION;
    };
    Map.prototype.getCheckpoint = function (car) {
        var checkpoint = this.chekpoints.find(function (item) { return item.contains(car.x, car.y); });
...
var Player = (function () {
    ...
    Object.defineProperty(Player.prototype, "direction", {
        get: function () {
            var direction = utils_1.DIRECTIONS.NONE;
    ...
    Object.defineProperty(Player.prototype, "velocity", {
        get: function () {
            var carSpeed = Math.abs(this._velocity);
            var maxSpeed = this.getMaxSpeed();
            if (this.direction && carSpeed < maxSpeed) {
                this._velocity += utils_1.ACCELERATION * this.direction;
            }
            else if ((this.direction && carSpeed > maxSpeed) || (!this.direction && carSpeed > 0)) {
                this._velocity -= utils_1.ACCELERATION * this._velocity;
            }
    ...
    Player.prototype.getMaxSpeed = function () {
        return utils_1.SPEED * this._map.getTileFriction(this.car);
    };
    Object.defineProperty(Player.prototype, "turn", {
        get: function () {
            var turn = utils_1.TURNS.NONE;
    ...
    Object.defineProperty(Player.prototype, "angle", {
        get: function () {
            return this.car.angle + this.turn * utils_1.SPEED / 2;
        },
        enumerable: false,
        configurable: true
    });
    Player.prototype.getVelocityFromAngle = function () {
    ...
    Player.prototype.move = function () {
        ...
        var velocity = this.getVelocityFromAngle();
        this.car.setVelocity(velocity.x, velocity.y);
        this.checkPosition();
    };
    Player.prototype.checkPosition = function () {
        var checkpoint = this._map.getCheckpoint(this.car);
        if (checkpoint) {
    ...
    Player.prototype.onCheckpoint = function (checkpoint) {
        ...
        else if (checkpoint === this._checkpoint + 1) {
            ++this._checkpoint;
        }
    };
    Player.prototype.slide = function () {
        this.car.angle += utils_1.SLIDE_ANGLE;
    };
    return Player;
}());
...
var Stats = (function () {
    ...
    Object.defineProperty(Stats.prototype, "complete", {
        get: function () {
    ...
    Stats.prototype.onLapComlete = function () {
        ++this.lap;
...
var StatsPanel = (function () {
    function StatsPanel(scene, stats) {
        this._scene = scene;
        this._stats = stats;
        this._style = { fontFamily: "CurseCasual", fontSize: "40px", color: "#E62B0D", stroke: "#000000", strokeThickness: 1, };
        this._lapsText = "Lap: ".concat(this._stats.lap, "/").concat(this._stats.laps);
    ...
    StatsPanel.prototype.create = function () {
        this._laps = this._scene.add.text(1100, 30, this._lapsText, this._style).setScrollFactor(0);
        this._time = this._scene.add.text(50, 650, "Time: ".concat(this._timeText), this._style).setScrollFactor(0);
        this._currentTime = this._scene.add.text(570, 650, "Lap time: ".concat(this._currentTimeText), this._style).setScrollFactor(0);
        this._bestTime = this._scene.add.text(1000, 650, "Best time: ".concat(this._bestTimeText), this._style).setScrollFactor(0);
    };
    StatsPanel.prototype.render = function () {
        ...
        if (this._stats.lap > this._stats.laps) {
            lapText = "Lap: ".concat(this._stats.laps, "/").concat(this._stats.laps);
        }
        else {
            lapText = "Lap: ".concat(this._stats.lap, "/").concat(this._stats.laps);
        }
        this._laps.setText(lapText);
        this._time.setText("Time: ".concat(this._timeText));
        this._currentTime.setText("Lap time: ".concat(this._currentTimeText));
        this._bestTime.setText("Best time: ".concat(this._bestTimeText));
    };
    return StatsPanel;
}());
...
var StatsPopup = (function () {
    function StatsPopup(scene, stats) {
        this._scene = scene;
        this._stats = stats;
    ...
    StatsPopup.prototype.showPopup = function () {
        var _this = this;
        var allTime = this._stats.time.toFixed(2);
        var bestTime = this._stats.timeBestLap.toFixed(2);
        ...
        this._scene.add.text(480, 260, "Whole time: ".concat(allTime), this._style).setScrollFactor(0);
        this._scene.add.text(480, 320, "Best lap: ".concat(bestTime), this._style).setScrollFactor(0);
        var tapText = this._scene.add.text(620, 400, "OK!", this._style).setScrollFactor(0);
        tapText.setInteractive({ useHandCursor: true });
        tapText.once("pointerdown", function () {
            _this._scene.scene.start("start-scene");
        });
    };
    return StatsPopup;
}());
exports["default"] = StatsPopup;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var BootScene_1 = __importDefault(__webpack_require__(/*! ./scenes/BootScene */ "./src/scenes/BootScene.ts"));
var GameScene_1 = __importDefault(__webpack_require__(/*! ./scenes/GameScene */ "./src/scenes/GameScene.ts"));
var PreloadScene_1 = __importDefault(__webpack_require__(/*! ./scenes/PreloadScene */ "./src/scenes/PreloadScene.ts"));
var StartScene_1 = __importDefault(__webpack_require__(/*! ./scenes/StartScene */ "./src/scenes/StartScene.ts"));
var config = {
    type: Phaser.AUTO,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var Map_1 = __importDefault(__webpack_require__(/*! ../classes/Map */ "./src/classes/Map.ts"));
var Player_1 = __importDefault(__webpack_require__(/*! ../classes/Player */ "./src/classes/Player.ts"));
var Stats_1 = __importDefault(__webpack_require__(/*! ../classes/Stats */ "./src/classes/Stats.ts"));
var StatsPanel_1 = __importDefault(__webpack_require__(/*! ../classes/StatsPanel */ "./src/classes/StatsPanel.ts"));
var StatsPopup_1 = __importDefault(__webpack_require__(/*! ../classes/StatsPopup */ "./src/classes/StatsPopup.ts"));
var utils_1 = __webpack_require__(/*! ../utils/utils */ "./src/utils/utils.ts");
var GameScene = (function (_super) {
    ...
    GameScene.prototype.onLapComplete = function (laps) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var LoadingBar_1 = __webpack_require__(/*! ../utils/LoadingBar */ "./src/utils/LoadingBar.ts");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var Client_1 = __importDefault(__webpack_require__(/*! ../classes/Client */ "./src/classes/Client.ts"));
var StartScene = (function (_super) {
    __extends(StartScene, _super);
    function StartScene() {
        var _this = _super.call(this, { key: "start-scene" }) || this;
        _this._style = { fontFamily: "CurseCasual", fontSize: "55px", color: "#ECE00C", stroke: "#000000", strokeThickness: 3, };
        return _this;
    }
    ...
    StartScene.prototype.create = function () {
        ...
        this._onePlayerTextButton.once("pointerdown", function () {
        ...
        this._twoPlayersTextButton.once("pointerdown", function () { return _this.requestGame(); });
    };
    StartScene.prototype.createButtonContainer = function (positionX, positionY, width, height, corner) {
        if (width === void 0) { width = 250; }
        if (height === void 0) { height = 100; }
        if (corner === void 0) { corner = 16; }
        this.add.graphics()
            .fillStyle(0x49BE25)
            .fillRoundedRect(positionX, positionY, width, height, corner);
    };
    StartScene.prototype.createText = function (positionX, positionY, text) {
        return this.add.text(positionX, positionY, text, this._style).setOrigin(0);
    };
    StartScene.prototype.requestGame = function () {
        var _this = this;
...
exports.SLIDE_ANGLE = 10;
exports.GRASS_FRICTION = 0.3;
...
const base64_arraybuffer_1 = __webpack_require__(/*! base64-arraybuffer */ "./node_modules/engine.io-client/node_modules/base64-arraybuffer/dist/base64-arraybuffer.es5.js");
